---
type: foundation
subtype: board-policy
title: "FENB Board Policy Manual"
version-date: "February 18, 2024"
governance-model: "Carver Policy Governance"
status: active
...
**GP-A2 — Board Discipline:** Enforce the discipline required to govern with excellence per code of conduct policy.

**GP-A3 — Monitoring of Board Performance:** Self-monitor per governing process policies on a preset schedule.
...
**GP-D3 — Commitment to Informed Decision-Making:** Prepare for meetings; be familiar with Board policies; thoughtfully consider all relevant information.

**GP-D4 — Respect for Different Points of View:** Encourage and show respect for other viewpoints; support decisions once fully discussed and resolved; do not direct differences to staff.

**GP-D5 — Report Non-Compliance:** Inform Chairperson of conditions or actions believed non-compliant with Board policies or FENB Bylaws.
...
| # | End Statement |
|---|---------------|
| GE-1 | Fencers that possess the knowledge, skills, and attitudes to participate recreationally and/or compete provincially, nationally or internationally |
| GE-2 | Opportunities for quality, accessible, recreational fencing |
| GE-3 | Qualified coaches and officials to lead and support athletes throughout their fencing experience |
| GE-4 | A fencing environment that meets recognized quality, safety, technical, and accountability standards |
| GE-5 | A sustainable and fair not-for-profit fencing community that recognizes the contribution and value of volunteers |
| GE-6 | An awareness and positive perspective of the sport of fencing |

> The Global Ends are nearly identical to the End Statements in the [[Strategic Plan 2024-2028]] — confirming strong internal alignment between the Board Policy Manual and the strategic plan.
...
|-----------|-----------|
| EDB-A1 (A+B) | No fencing without certified coach supervision; no training that pressures physical/mental self-injury |
| EDB-A2 | No FENB equipment used without certified coach/volunteer aware of safety requirements |
| EDB-A3 | Host organizers of sanctioned competitions must know safe conduct requirements (waivers, field of play, equipment verification, First Aid) |
| EDB-A4 (A–D) | No member uninformed of program details; no restriction to access higher-level outside-province programs; no required club recreational programming |
| EDB-A5 | No support for coaches/officials who violate FENB values or could damage reputation |
| EDB-A6 | No member uninformed of respectful conduct expectations |
| EDB-A7 | No members abused or harassed |
| EDB-A8 | Members' privacy and confidentiality must be ensured |
| EDB-A9 | Policy documents in both official languages; access to accurate interpretation |
...
| Sub-policy | Limitation |
|-----------|-----------|
| EDB-B1 Financial Safety Net | Funds on hand must not fall below **one year's ED salary + general administrative costs** without Board approval |
| EDB-B2 Budget Preparation | Must prepare annual budget credibly projecting revenues and expenses aligned to strategic plan |
| EDB-B3 Investments | No investments that put principal at risk or cause funds to be unavailable when needed |
| EDB-B4 Payment of Debts | Must settle debts in a timely manner |
| EDB-B5 Collection of Receivables | Must pursue collection after reasonable grace period |
| EDB-B6 Accounting Control | Must meet Provincial government audit/review standards |
...
- EDB-C2: FENB equipment must not be insufficiently maintained
- EDB-C3: Must implement risk management plan to minimize liability exposure
...
- EDB-E2: Inform Board of changes in internal or external environment requiring policy reconsideration
- EDB-E3: Provide as many staff and external points of view as possible for Board decision-making
- EDB-E4: Deal with the Board as a whole (except for individual information requests or responses to duly charged committees/officers)
...
**BEDR-A — Unity of Control:** Only decisions of the Board acting as a single unit are binding to the ED.

**BEDR-B — Accountability of the ED:** The ED is the Board's only link to operational achievement; all staff authority and accountability flows through the ED.

**BEDR-B1 — ED Performance:** Board views ED performance as identical to organizational performance; achieving Ends within Boundaries = successful performance.

**BEDR-C — Delegation:** Board instructs ED through written policies prescribing Ends and describing situations/actions to avoid. The ED may use any reasonable interpretation of these policies.

**BEDR-C1 — Further Policy by ED:** As long as the ED uses any reasonable interpretation of Ends and Boundaries, the ED is authorized to establish further operational policies, make all decisions, take all actions.

**BEDR-C2 — Respect for ED Choices:** Board will respect and support ED choices made within reasonable interpretation of Ends and Boundaries.

**BEDR-D — Monitoring ED Performance:** Monitored solely against accomplishment of Board Ends policies and compliance with Executive Boundaries.

**BEDR-D2 — Monitoring Methods:** Internal report (ED self-disclosure), external report (third-party assessment), or direct Board inspection.

**BEDR-D3 — Frequency:** Per the monitoring schedule (see below).

**BEDR-E — Operations by Board Members:** When a Board member undertakes operational roles, they report to and follow direction of the ED for those roles.

### Monitoring Schedule

| Policy | Method | Frequency |
|--------|--------|-----------|
| EDB-A Treatment of Members, Volunteers, Others | Internal | Semi-annually |
| EDB-B Financial Planning, Condition & Activities | Internal | Quarterly |
| EDB-B Financial Planning, Condition & Activities | External | Annually |
| EDB-C Asset Protection | Internal | Annually |
